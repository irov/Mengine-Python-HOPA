...
class AliasInventoryCombineInventoryItem(TaskAlias):
    ...
    def _onGenerate(self, source):
        source.addTask("TaskInventoryCombineInventoryItem", Inventory=self.Inventory, AttachInventoryItem=self.AttachInventoryItem, SlotInventoryItem=self.SlotInventoryItem)
        ...
        with GuardBlockInput(source) as guard_scope:
            ...
            guard_scope.addTask("TaskSceneLayerAddEntity", LayerName="InventoryItemEffect", Object=SlotInventoryItem, AdaptScreen=True)
            guard_scope.addTask("TaskSceneLayerAddEntity", LayerName="InventoryItemEffect", Object=AttachInventoryItem, AdaptScreen=True)
