...
class HintActionCombine(HintActionMultiTarget):
    ...
    #     with TaskManager.createTaskChain(Name = "HintActionCombinePlay") as tc:
    ...
    #
    #         PolicyHintWay = PolicyManager.getPolicy("HintWay")
    #         tc.addTask(PolicyHintWay, Point = PositionTo1, Position = PositionTo2)
    #         tc.addCallback(self.appendInterruptCb,PolicyHintWayInterrupt)
    #
    #         with tc.addParallelTask(2) as (tc_way2, tc_target2):
    ...
    #         pass
    #
    #     with TaskManager.createTaskChain(Name = "HintActionCombine", Cb = self.listInterruptClean) as tc:
    #         tc.addTask("TaskInventoryCarriageChange", Inventory = self.Inventory)
    ...
    #
    # def _onEnd(self):
    #     if TaskManager.existTaskChain("HintActionCombinePlay") is True:
    #         TaskManager.cancelTaskChain("HintActionCombinePlay")
    #     if TaskManager.existTaskChain("HintActionCombine") is True:
    #         TaskManager.cancelTaskChain("HintActionCombine")
    #
