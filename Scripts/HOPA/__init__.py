def onInitialize():
    ...
    Managers.importManager("HOPA", "ColoringPuzzleManager")
    ...
    Managers.importManager("HOPA", "FragmentsRollManager")
    ...
    Managers.importManager("HOPA", "PathChipsCryptManager")
    Managers.importManager("HOPA", "PopUpItemManager")
    Managers.importManager("HOPA", "QuestManager")
    Managers.importManager("HOPA", "RotateAndSwapChipsManager")
    ...
    Managers.importManager("HOPA", "WalktrhoughTextManager")
...
def onFinalize():
    ...
    Managers.removeManager("HOPA", "ColoringPuzzleManager")
    ...
    Managers.removeManager("HOPA", "FragmentsRollManager")
    ...
    Managers.removeManager("HOPA", "PathChipsCryptManager")
    Managers.removeManager("HOPA", "PopUpItemManager")
    Managers.removeManager("HOPA", "QuestManager")
    Managers.removeManager("HOPA", "RotateAndSwapChipsManager")
    ...
    Managers.removeManager("HOPA", "WalktrhoughTextManager")
