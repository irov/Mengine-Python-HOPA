...
class PolicyHintInventoryTargetLoopEffect(TaskAlias):
    ...
    def _onGenerate(self, source):
        source.addTask("TaskObjectSetPosition", GroupName="HintEffect",
                       ObjectName="Movie_HintInventoryTargetLoop", Value=self.Position)
        source.addTask("TaskMoviePlay", GroupName="HintEffect", MovieName="Movie_HintInventoryTargetLoop",
                       Loop=True, Wait=False)
