...
class PolicyBlackBarPlayStatic(TaskAlias):
    ...
    def _onGenerate(self, source):
        ...
        if self.Group.hasObject("Sprite_BlackBar") is True:
            ...
            source.addTask("AliasObjectAlphaTo", ObjectName="Sprite_BlackBar", Time=0.1 * 1000, From=0.0, To=1.0)  # speed fix
            pass
        ...
        if self.Group.hasObject("Sprite_BlackBar") is True:
            source.addTask("AliasObjectAlphaTo", ObjectName="Sprite_BlackBar", Time=0.1 * 1000, To=0.0)  # spees fix
