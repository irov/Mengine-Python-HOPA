...
class PolicyHintTargetEffectWait(TaskAlias):
    ...
    def _onGenerate(self, source):
        source.addTask("TaskObjectSetPosition", GroupName="HintEffect",
                       ObjectName="Movie2_HintTarget", Value=self.Position)
        source.addTask("TaskMovie2Play", GroupName="HintEffect", Movie2Name="Movie2_HintTarget",
                       Wait=True, Loop=False)  # Loop=True
