...
class MacroFramePickItem(MacroCommand):
    ...
    def _onGenerate(self, source):
        ...
        Quest = self.addQuest(source, "PickItem", SceneName=self.SceneName,
                              GroupName=self.GroupName, ItemName=ItemObjectName)
        ...
        if ItemManager.hasItemInventoryItem(self.ItemName) is True:
            Quest = self.addQuest(source, "GetItem", SceneName=self.SceneName,
                                  GroupName=self.GroupName, Object=self.Button)
