...
class MacroAddBone(MacroCommand):
    ...
    def _onGenerate(self, source):
        ...
        Quest = self.addQuest(source, "BoneAdd", SceneName=self.SceneName, GroupName=GroupName, Object=Object, InventoryItem=InventoryItem)
        with Quest as tc_quest:
            tc_quest.addTask("TaskNotify", ID=Notificator.onBoneAdd, Args=(self.ItemName, self.bone_item))
            tc_quest.addTask("TaskSocketPlaceInventoryItem", Socket=Object, InventoryItem=InventoryItem, Taken=False, Pick=True)
