...
class TrialMobile(BaseEntity):
    ...
    def _onInitialize(self, *args, **kwargs):
        super(TrialMobile, self)._onInitialize(*args, **kwargs)
    ...
    def _onPreparation(self):
        super(TrialMobile, self)._onPreparation()

    def _onActivate(self):
        super(TrialMobile, self)._onActivate()
    ...
    def _onDeactivate(self):
        super(TrialMobile, self)._onDeactivate()
