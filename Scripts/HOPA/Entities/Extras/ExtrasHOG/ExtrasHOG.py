...
class ExtrasHOG(BaseEntity):
    ...
    def _onPreparation(self):
        super(ExtrasHOG, self)._onPreparation()
        Data = ExtrasHOGManager.getData()
    ...
    def __activateEnigma(self):
        sceneName, scenarioID = self.Collection[self.sprites[self.currentIndex]]

        Notification.notify(Notificator.onExtraHOGPlay, sceneName, scenarioID)
        pass
